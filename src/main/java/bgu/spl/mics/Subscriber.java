...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private MessageBroker theBroker;
    private Map<Class<? extends Message>,Callback> topicToCallbackMap;
    ...
    public Subscriber(String name) {
        ...
        topicToCallbackMap=new HashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        theBroker.subscribeEvent(type,this);
        topicToCallbackMap.putIfAbsent(type,callback);
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        theBroker.subscribeBroadcast(type,this);
        topicToCallbackMap.putIfAbsent(type,callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message msg = theBroker.awaitMessage(this);
                topicToCallbackMap.get(msg.getClass()).call(msg);//calling the callback means running the method
            }
            catch (InterruptedException e){this.terminate();}
        }
    }
}